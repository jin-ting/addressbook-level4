...
import static seedu.address.logic.commands.LocateCommand.MESSAGE_LOCATE_PERSON_SUCCESS;
...
public class LocateCommandSystemTest extends AddressBookSystemTest {
    ...
    public void select() {
         ...
         * -> selected
         */
        String command = "   " + LocateCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased() + "   ";
        ...
        command = LocateCommand.COMMAND_WORD + " " + personCount.getOneBased();
        ...
        command = LocateCommand.COMMAND_WORD + " " + middleIndex.getOneBased();
        assertCommandSuccess(command, middleIndex);

        /* Case: invalid index (size + 1) -> rejected */
        int invalidIndex = getModel().getFilteredPersonList().size() + 1;
        assertCommandFailure(LocateCommand.COMMAND_WORD + " " + invalidIndex, MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
        ...
        command = LocateCommand.COMMAND_WORD + " " + validIndex.getOneBased();
        assertCommandSuccess(command, validIndex);

        /* Case: invalid index (0) -> rejected */
        assertCommandFailure(LocateCommand.COMMAND_WORD + " " + 0,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, LocateCommand.MESSAGE_USAGE));

        /* Case: invalid index (-1) -> rejected */
        assertCommandFailure(LocateCommand.COMMAND_WORD + " " + -1,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, LocateCommand.MESSAGE_USAGE));

        /* Case: invalid arguments (alphabets) -> rejected */
        assertCommandFailure(LocateCommand.COMMAND_WORD + " abc",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, LocateCommand.MESSAGE_USAGE));

        /* Case: invalid arguments (extra argument) -> rejected */
        assertCommandFailure(LocateCommand.COMMAND_WORD + " 1 abc",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, LocateCommand.MESSAGE_USAGE));
        ...
        assertCommandFailure(LocateCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased(),
    ...
    private void assertCommandSuccess(String command, Index expectedSelectedCardIndex) {
        ...
        String expectedResultMessage = String.format(
                MESSAGE_LOCATE_PERSON_SUCCESS, expectedSelectedCardIndex.getOneBased());
